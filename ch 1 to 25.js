...
// alert ("Happy Coding!");
5
// a5=("Hello...I can run JS through my web browser's console.")
// console.log(a5);
6
// alert("Welcome to our World");
//...........................................................................................//
...
// var email2=" pearlice6@gmail.com"
// var email3= email1 + email2
// alert(email3)

// 7
// var booka= "Im trying to learn from a BOOK"
// var bookb=" A smarter way to learn JavaScript"
// var bookc= booka + bookb
// alert(bookc)


// 8
// a= " Yah! I can write HTML content thorough Java Script"
// document.write(a) 
...
// var a= "Data type of my declared variable is number"
// var b= birthyear + "<br>" + a
// document.write (b)
...
// var f = a.fontsize(6).bold()  + " <br>" + " <br>" + " <br>" + b +" <br>" + c + " <br>" + d +" <br>" + e
// document.write (f)
...
// var k2 = 3;
// var l = k1 % k2 ;
// document.write ("The remainder is :" + " " + l );
...
// document.write( z + convertInC + degree1.sup() + "C" );
...
// document.write(complete + percentage + " %")
...
// document.write(currency.fontsize(7).bold()+ " <br>" + " <br>"+ "Total currency in PKR: " + totalcurrency)
...
// document.write (ex11.bold().fontsize(7) + "<br>"+"Current year: 2020 " + "<br>"+ "Birth year: 2002 " + "<br>" + "Your age is "+ Age)
...
// document.write(ex12.fontsize(7)+ "<br>" + "Radius of a circle: 20"+ "<br>" + "The circumference is " + circumference )
...
// }
//  else if (character >= String.fromCharCode (48) && character <= String.fromCharCode (57)){
...
2
// var int = prompt("Enter first number")
// var int2 = prompt("Enter Second number")
// if (int > int2){
//     alert (int +" is larger integer")
// }
// else if (int2 > int){
//     alert (int2 + " is larger integer")
// }
// else if (int === int ){
...
// 7
// var hour = prompt("Enter time in 24 hours clock format like: 1900 = 7pm")
...
// var no;
// for(var no=1 ; no <= lenght ; no++){
//     document.write(table +" x " + no + " = " + table*no + "<br>")
// }
...
// document.write("The smallest number is: " + Math.min(...a2));
